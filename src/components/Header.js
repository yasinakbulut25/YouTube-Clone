...
function Header() {
  const { controlSidebar, theme, changeTheme } = useContext(AppContext);
  const [profileMenu, setProfileMenu] = useState(false);

  const profileMenuControl = () => setProfileMenu(!profileMenu);
  return (
    <header className="header main-bg light-text">
      <div className="logo-area">
        <div className="bar">
          <i onClick={controlSidebar} className="material-icons">
            menu
          </i>
        </div>
        <div className="logo">
          <a href="./">
            ...
            >
              ...
              >
                ...
                <g className="style-scope yt-icon logo-text">
      ...
      <div className="search-area">
        <div className="input-container">
          <div className="search-icon-focus center">
      ...
      <div className="profile-area">
        <i onClick={changeTheme} className="material-icons">
        ...
        <div className="profile-image">
          <img
            onClick={profileMenuControl}
            src={UserProfile}
            alt="user profile"
          />
          {profileMenu ? (
            <div className="options-menu profile">
              <div className="option-section profile">
                <div className="option-profile">
                  <img src={UserProfile} alt="profile" />
                  <div className="option-profile-texts">
                    <span className="light-text">Yasin Akbulut</span>
                    <span className="light-text">example@gmail.com</span>
                    <Link>Manage your Google Account</Link>
                  </div>
                </div>
              </div>
              <div className="option-section">
                <Link className="light-text">
                  <span>
                    <i className="material-icons">account_box</i> Create a
                    channel
                  </span>
                </Link>
                <Link className="light-text">
                  <span>
                    <i className="material-icons">switch_account</i> Switch
                    Account
                  </span>
              ...
              <div className="option-section">
                ...
                <Link className="light-text">
                  <span>
                    <i className="material-icons">translate</i> Language:
                    English
                  </span>
                  <i className="material-icons">chevron_right</i>
                </Link>
                <Link className="light-text">
                  <span>
                    <i className="material-icons">language</i> Location: Turkey
                  </span>
                  <i className="material-icons">chevron_right</i>
                </Link>
                <Link className="light-text">
                  <span>
                    <i className="material-icons">keyboard</i> Keyboard
                    Shortcuts
                  </span>
                </Link>
              </div>
              ...
              <div className="option-section">
                ...
                <Link className="light-text">
                  <span>
                    <i className="material-icons">announcement</i> Send feedback
                  </span>
                </Link>
              </div>
            </div>
